...
const ModalNewCommand = forwardRef(({ callBack }, ref) => {
    ...
    const addCommand = () => {
        const temp = {
            ...CommandeValue,
            expiring_date: formatDate(CommandeValue.expiring_date),
        };
        setLoading(true);
        // console.log(object);
        // return
        axios
            .post("/api/commands", temp)
            .then(() => {
    ...
    return (
        <>
            <ModalComponent
                ...
                name="Nouveau"
            >
                <ModalComponent.Header>Vente</ModalComponent.Header>
                <ModalComponent.Body>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <div>
                                <div className="mb-2 block">
                                    <Label value="Nom du client" />
                                </div>
                                <TextInput
                                    value={CommandeValue.name}
                                    onInput={(e) =>
                            ...
                            <div>
                                <div className="mb-2 block">
                                    <Label value="  Date d'expiration" />
                                </div>
                                <Datepicker
                                    theme={style}
                                    value={`${CommandeValue.expiring_date}`.slice(
                                        0,
                                        10
                                    )}
                                    onSelectedDateChanged={(date) => {
                                        console.log(date);
                                        onInput("expiring_date", date);
                                    }}
                                    color="white"
                                />
                            </div>
